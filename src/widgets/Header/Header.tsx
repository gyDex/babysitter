    ...
    return (
        <div className={styles.header}>
            <div className={headerState.isTransparent ? styles['header__inner_transparent'] : styles.header__inner}>
                ...
                {
                    city !== undefined && (pathName.includes('/profile-parent/') || pathName === '/auth' || pathName === '/authWithoutSub') && <div className={styles['header__city']}>
                ...
                {
                    <div className={clsx({
                        ['hidden']: (pathName === '/auth' || pathName === '/authWithoutSub') || pathName.includes('/profile-parent/'),
                    })}>
                ...
                {
                    pathName.includes('/profile-parent/') && <div className={styles['header__right-auth']}>
