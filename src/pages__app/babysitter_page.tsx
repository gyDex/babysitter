    ...
    return (
        <>
            ...
            <div className="min-[1200px]:hidden">
                ...
                <MobileModal title={'Для отклика необходимо пройти небольшую регистрацию '} isOpen={mobileState.isRegister} next={() => {
                  
                  router.push('/register')}} setOpen={mobileState.setRegister}>
                </MobileModal>
            </div>
            ...
            }} isOpen={mobileState.isRegister}  next={() => {router.push('/register')}} setOpen={mobileState.setRegister} btnTitle={'Продолжить бесплатно'}  title={false}>
            ...
            [
              {
                ...
                icon: <svg width="55" height="60" viewBox="0 0 55 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M32.0016 58C50.3764 39.9612 63.2711 9.51019 44.0523 2.80768C24.8335 -3.89483 17.1953 33.3873 26.7225 31.1072C36.2498 28.827 18.0999 4.55808 7.16813 12.4913C-3.76369 20.4245 1.80668 44.2777 32.0016 58Z" stroke="#F3E19C" stroke-width="2.5"/>
                </svg>
              },
              {
              ...
              },
              {
                ...
                icon: <svg style={{
                  ...
                  top: '15px'
                    ...
                    <path d="M64.1215 2L5 19.8195L21.6108 24.8944M64.1215 2L21.6108 24.8944M64.1215 2L56.8971 38.1249L36..5455M64.1215 2L32.742 29.161M21.6108 24.8944L25.3954 43M32.742 29.161L25.3954 43M32.742 29.161L36.4729 30.5455M25.3954 43L36.4729 30.5455" stroke="#F3E19C" stroke-width="2.5"/>
                </svg>
              },
              {
                title: <>Принимайте заявки <br /> родителей – потому что мы <br /> разместим вас в список нянь <br /> вашего города</>,
                icon: <svg style={{
                  right: '20px',
                  top: '15px'
                }} width="58" height="54" viewBox="0 0 58 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.8139 24.1443L27.1518 40.1039C31.8727 31.8591 44.476 12.4956 57.1224 1M2 11.0115L4.2331 52L45.8981 49.2321L43.0186 9.00924L2 11.0115Z" stroke="#F3E19C" stroke-width="2.5"/>
                </svg>
