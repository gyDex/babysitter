...
const ProfileEditEightStage = () => {
  ...
  const { setName, setEmail, setLocation, setAge, age, email, name, location } = useAnketsBabysitter();
      ...
      <div className="flex w-full gap-[16px] max-[768px]:flex-col">
        ...
        <div className="w-full min-[1024px]:max-w-[171px]">
          <input
            ...
            placeholder="28"
          />
          <span className="text-red-500 font-[onest] text-sm">{errors.age?.message}</span>
