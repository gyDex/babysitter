    ...
    <div className={styles['profile-edit-stage']}>
        ...
        <div className={styles['profile-edit-stage__content_three']}>
            <div className={styles['profile-edit-stage__check-list']}> 
                <ProfileEditCheckItem text='Развивающие занятия' />
                <ProfileEditCheckItem text='Рисование' />
                <ProfileEditCheckItem text='Обучение языкам' />
                <ProfileEditCheckItem text='Пение' />
                <ProfileEditCheckItem text='Танцы' />
                <ProfileEditCheckItem text='На усмотрение специалиста' />
            </div>
            <textarea placeholder='Дополнительный вопрос ' className='border-1 border-[#D9D9D9] w-full px-[16px] py-[18px] rounded-[16px] text-[#D9D9D9] text-[18px] leading-[24px] font-normal min-h-[145px] min-[768px]:hidden' />

            <input className='border-1 border-[#D9D9D9] w-full px-[16px] py-[18px] rounded-[16px] text-[#D9D9D9] text-[18px] leading-[24px] font-normal max-[768px]:hidden' placeholder='Дополнительный вопрос '  />
        </div>
